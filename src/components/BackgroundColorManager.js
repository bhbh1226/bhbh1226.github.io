...
const backgroundColors = [{
  ...
  sky: [150, 150, 150, 226, 226, 226], // 2 4.2
  ground: [120, 120, 120], // 1
  starLight: [221, 221, 221], // 4
  starDark: [204, 204, 204], // 3
  lineLight: [204, 204, 204, 204, 204, 204], // 3
  lineDark: [120, 120, 120, 120, 120, 120], //1
  cloudWhite: [238, 238, 238, 238, 238, 238], // 5
